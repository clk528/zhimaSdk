...
class ZmopClient {
	...
	function __construct($appId = '', $privateKeyFilePath, $zhiMaPublicKeyFilePath){
		$this -> appId = $appId;
	...
	public function execute($request) {
		...
		if(is_object($bizRespObject)){
            return (array)$bizRespObject;
        }
	...
	public function generatePageRedirectInvokeUrl($request){
        ...
        $systemParams[$this->bizParam] = RSAUtil::rsaEncrypt($apiParamsQuery, $this->zhiMaPublicKeyFilePath);
